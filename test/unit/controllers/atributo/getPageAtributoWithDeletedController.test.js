...
import GetPageAtributoWithDeletedController from '../../../../src/controllers/atributo/GetPageAtributoWithDeletedController.js';

describe('Unit Test: GetPageAtributoWithDeletedController', () => {
    let controller;
    const rows = [
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetPageAtributoWithDeletedController(mockRepository);
    });

    it('Obtiene una página de atributos (incluyendo eliminados) exitosamente', async () => {
        const pag = 1, limit = 2;
