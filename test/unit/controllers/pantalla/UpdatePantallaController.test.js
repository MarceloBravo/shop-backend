import UpdatePantallaController from '../../../../src/controllers/pantalla/UpdatePantallaController.js';

const mockService = {
    execute: jest.fn()
};

jest.mock('../../../../src/services/pantalla/UpdatePantallaService.js', () => {
...
describe('Unit Test: UpdatePantallaController', () => {
    ...
    it('Actualiza un pantalla exitosamente', async () => {
    ...
    it('Maneja errores internos correctamente', async () => {
        const req = { params: { id: 1 }, body: { nombre: 'ADMIN', uri: 'admin' } };
        const res = { json: jest.fn(), status: jest.fn().mockReturnThis() };
