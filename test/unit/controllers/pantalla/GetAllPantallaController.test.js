import GetAllPantallaController from '../../../../src/controllers/pantalla/GetAllPantallaController.js';
...
describe('Unit Test: GetAllPantallaController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetAllPantallaController(mockRepository);
        controller.service = mockService;
    });

    it('Obtiene todos los pantallas exitosamente', async () => {
    ...
    it('throw a error if none repository is provided', () => {
        expect(() => new GetAllPantallaController()).toThrow('No se ha recibido un repositorio');
    });
});