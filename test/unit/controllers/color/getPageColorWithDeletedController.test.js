...
import GetPageColorWithDeletedController from '../../../../src/controllers/color/GetPageColorWithDeletedController.js';

describe('Unit Test: GetPageColorWithDeletedController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetPageColorWithDeletedController(mockRepository);
    });

    it('Obtiene una página de colores (incluyendo eliminados) exitosamente', async () => {
        const pag = 1, limit = 2;
        const rows = [
