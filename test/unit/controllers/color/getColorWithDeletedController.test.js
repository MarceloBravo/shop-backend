...
import GetColorWithDeletedController from '../../../../src/controllers/color/GetColorWithDeletedController.js';

describe('Unit Test: GetColorWithDeletedController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetColorWithDeletedController(mockRepository);
    });

    it('Obtiene un color (incluyendo eliminados) exitosamente', async () => {
        const id = 1;
