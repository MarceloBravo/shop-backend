...
import GetPageColorController from '../../../../src/controllers/color/GetPageColorController.js';

describe('Unit Test: GetPageColorController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetPageColorController(mockRepository);
    });
