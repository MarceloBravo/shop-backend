import GetPageMenuTiendaController from '../../../../src/controllers/menuTienda/GetPageMenuTiendaController.js';
...
describe('Unit Test: GetPageMenuTiendaController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetPageMenuTiendaController(mockRepository);
        controller.service = mockService;
    });

    it('Obtiene una pagina de menuTiendas exitosamente', async () => {
    ...
    it('throw a error if none repository is provided', () => {
        expect(() => new GetPageMenuTiendaController()).toThrow('No se ha recibido un repositorio');
    });
});