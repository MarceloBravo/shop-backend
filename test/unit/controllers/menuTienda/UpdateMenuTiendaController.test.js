import UpdateMenuTiendaController from '../../../../src/controllers/menuTienda/UpdateMenuTiendaController.js';

const mockService = {
    execute: jest.fn()
};

jest.mock('../../../../src/services/menuTienda/UpdateMenuTiendaService.js', () => {
...
describe('Unit Test: UpdateMenuTiendaController', () => {
    ...
    it('Actualiza un menuTienda exitosamente', async () => {
    ...
    it('Maneja errores internos correctamente', async () => {
        const req = { params: { id: 1 }, body: { nombre: 'Inicio', icono: 'path/to/icono.png', menu_padre_id: null, uri: '/inicio', posicion: 1, pantalla_id: 1 }};
        const res = { json: jest.fn(), status: jest.fn().mockReturnThis() };
