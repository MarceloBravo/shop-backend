import GetByIdMenuTiendaController from '../../../../src/controllers/menuTienda/GetByIdMenuTiendaController.js';
...
describe('Unit Test: GetByIdMenuTiendaController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetByIdMenuTiendaController(mockRepository);
        controller.service = mockService;
    });

    it('Obtiene un menuTienda por id exitosamente', async () => {
    ...
    it('throw a error if none repository is provided', () => {
        expect(() => new GetByIdMenuTiendaController()).toThrow('No se ha recibido un repositorio');
    });
});