import GetPageAccionesPantallaWithDeletedController from '../../../../src/controllers/accionesPantalla/GetPageAccionesPantallaWithDeletedController.js';
...
describe('Unit Test: GetPageAccionesPantallaWithDeletedController', () => {
    let controller;
    ...
    it('Obtiene una página de acciones de pantalla (incluyendo eliminadas) exitosamente', async () => {
    ...
    it('throw a error if none repository is provided', () => {
        expect(() => new GetPageAccionesPantallaWithDeletedController()).toThrow('No se ha recibido un repositorio');
    });
}); 