import GetAllAccionesPantallaWithDeletedController from '../../../../src/controllers/accionesPantalla/GetAllAccionesPantallaWithDeletedController.js';
...
describe('Unit Test: GetAllAccionesPantallaWithDeletedController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetAllAccionesPantallaWithDeletedController(mockRepository);
        controller.service = mockService;
    });

    it('Obtiene todas las acciones de pantalla (incluyendo eliminadas) exitosamente', async () => {
    ...
    it('throw a error if none repository is provided', () => {
        expect(() => new GetAllAccionesPantallaWithDeletedController()).toThrow('No se ha recibido un repositorio');
    });
}); 