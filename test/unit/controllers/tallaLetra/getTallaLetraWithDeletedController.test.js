...
import GetByIdTallaLetraWithDeletedController from '../../../../src/controllers/tallaLetra/GetByIdTallaLetraWithDeletedController.js';

describe('Unit Test: GetByIdTallaLetraWithDeletedController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetByIdTallaLetraWithDeletedController(mockRepository);
    });

    it('Obtiene un tallaLetra por ID (incluyendo eliminados) exitosamente', async () => {
        // Arrange
