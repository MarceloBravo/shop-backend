...
import GetPageTallaLetraController from '../../../../src/controllers/tallaLetra/GetPageTallaLetraController.js';

describe('Unit Test: GetPageTallaLetraController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetPageTallaLetraController(mockRepository);
    });

    it('Obtiene una página de tallaLetraes exitosamente', async () => {
        // Arrange
