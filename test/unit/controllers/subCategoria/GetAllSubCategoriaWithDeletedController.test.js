...
describe('GetAllSubCategoriaWithDeletedController', () => {
    ...
    beforeEach(() => {
        controller = new GetAllSubCategoriaWithDeletedController(mockRepository);
        req = {};
        res = {
            json: jest.fn(),
    ...
    it('throw a error if none repository is provided', () => {
        expect(() => new GetAllSubCategoriaWithDeletedController()).toThrow('No se ha recibido un repositorio');
    });
});