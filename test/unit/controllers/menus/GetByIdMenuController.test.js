import GetByIdMenuController from '../../../../src/controllers/menu/GetByIdMenuController.js';
...
describe('Unit Test: GetByIdMenuController', () => {
    let controller;
    ...
    it('Obtiene un menu por id exitosamente', async () => {
