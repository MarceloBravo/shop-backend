import GetAllMenuController from '../../../../src/controllers/menu/GetAllMenuController.js';
...
describe('Unit Test: GetAllMenuController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetAllMenuController(mockRepository);
        controller.service = mockService;
    });

    it('Obtiene todos los menus exitosamente', async () => {
    ...
    it('throw a error if none repository is provided', () => {
        expect(() => new GetAllMenuController()).toThrow('No se ha recibido un repositorio');
    });
});