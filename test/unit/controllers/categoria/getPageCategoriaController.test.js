...
import GetPageCategoriaController from '../../../../src/controllers/Categoria/GetPageCategoriaController.js';

describe('Unit Test: GetPageCategoriaController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetPageCategoriaController(mockRepository);
    });
