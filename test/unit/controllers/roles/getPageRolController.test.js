...
import GetPageRolController from '../../../../src/controllers/Rol/GetPageRolController.js';

describe('Unit Test: GetPageRolController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetPageRolController(mockRepository);
    });

    it('Obtiene una página de roles exitosamente', async () => {
        // Arrange
