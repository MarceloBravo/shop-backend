...
import GetByIdRolController from '../../../../src/controllers/Rol/GetByIdRolController.js';

describe('Unit Test: GetByIdRolController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetByIdRolController(mockRepository);
    });

    it('Obtiene un rol por ID exitosamente', async () => {
        // Arrange
