...
import SoftDeleteRolController from '../../../../src/controllers/Rol/SoftDeleteRolController.js';

describe('Unit Test: SoftDeleteRolController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new SoftDeleteRolController(mockRepository);
    });

    it('Borra lógicamente un rol exitosamente', async () => {
        // Arrange
