...
import GetByIdTallaNumeroWithDeletedController from '../../../../src/controllers/tallaNumero/GetByIdTallaNumeroWithDeletedController.js';

describe('Unit Test: GetByIdTallaNumeroWithDeletedController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetByIdTallaNumeroWithDeletedController(mockRepository);
    });

    it('Obtiene un tallaNumero por ID (incluyendo eliminados) exitosamente', async () => {
        // Arrange
