...
import GetPageMarcaWithDeletedController from '../../../../src/controllers/marca/GetPageMarcaWithDeletedController.js';

describe('Unit Test: GetPageMarcaWithDeletedController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetPageMarcaWithDeletedController(mockRepository);
    });

    it('Obtiene una página de marcaes (incluyendo eliminados) exitosamente', async () => {
        const pag = 1, limit = 2;
        const rows = [
