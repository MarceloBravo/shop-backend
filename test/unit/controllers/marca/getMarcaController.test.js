...
import GetMarcaController from '../../../../src/controllers/marca/GetByIdMarcaController.js';

describe('Unit Test: GetMarcaController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetMarcaController(mockRepository);
    });

    it('Obtiene un marca exitosamente', async () => {
        const id = 1;
        const marca = { id, nombre: 'Rojo', logo: 'path/to/logo.png' };
