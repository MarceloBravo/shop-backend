...
import GetPageValoracionProductoController from '../../../../src/controllers/ValoracionProducto/GetPageValoracionProductoController.js';
...
describe('GetPageValoracionProductoController', () => {
    ...
    it('debe retornar una página de valoraciones de productos', async () => {
        ...
        expect(service.execute).toHaveBeenCalledWith(1, 10);
