...
import GetPageRolPermisosWithDeletedController from '../../../../src/controllers/RolPermisos/GetPageRolPermisosWithDeletedController.js';

describe('Unit Test: GetPageRolPermisosWithDeletedController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetPageRolPermisosWithDeletedController(mockRepository);
    });

    it('Obtiene una página de rolPermisoses (incluyendo eliminados) exitosamente', async () => {
        // Arrange
