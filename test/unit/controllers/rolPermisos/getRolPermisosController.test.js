...
import GetByIdRolPermisosController from '../../../../src/controllers/RolPermisos/GetByIdRolPermisosController.js';

describe('Unit Test: GetByIdRolPermisosController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetByIdRolPermisosController(mockRepository);
    });

    it('Obtiene un rolPermisos por ID exitosamente', async () => {
        // Arrange
