...
import GetPageGeneroController from '../../../../src/controllers/genero/GetPageGeneroController.js';

describe('Unit Test: GetPageGeneroController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetPageGeneroController(mockRepository);
    });
