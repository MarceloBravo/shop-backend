...
import SoftDeleteMaterialesController from '../../../../src/controllers/materiales/SoftDeleteMaterialController.js';

describe('Unit Test: SoftDeleteMaterialesController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new SoftDeleteMaterialesController(mockRepository);
    });

    it('Borra lógicamente un materiales exitosamente', async () => {
        const id = 1;
