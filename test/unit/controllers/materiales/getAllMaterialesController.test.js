...
jest.mock('../../../../src/models/MaterialModel.js', () => ({
    MaterialModel: {
...
import GetAllMaterialesController from '../../../../src/controllers/materiales/GetAllMaterialController.js';

describe('Unit Test: GetAllMaterialesController', () => {
    let controller;

    beforeEach(() => {
        jest.clearAllMocks();
        controller = new GetAllMaterialesController(mockRepository);
    });

    it('Obtiene todos los materialess exitosamente', async () => {
        // Arrange
        const mockResponse = {
            data: [{
                "id": 38,
