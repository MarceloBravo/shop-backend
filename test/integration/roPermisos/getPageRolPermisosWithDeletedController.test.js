...
describe('Integration Test: GetPageRolPermisosWithDeletedController', () => {
    let token;
    let rol;
    let pantalla;
    ...
    const rolData = { nombre: 'TestRolForGetPageDeleted' };
    const pantallaData = { nombre: 'TestPantallaForGetPageDeleted', uri: '/test-getpagedeleted' };
    ...
    it('debe obtener una página de permisos de rol eliminados lógicamente, incluyendo el de prueba', async () => {
        const response = await request(app)
            .get('/api/v1/rol_permisos/deleted/page/1/10')
