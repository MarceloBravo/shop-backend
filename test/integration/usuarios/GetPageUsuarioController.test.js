...
describe('GetPageUsuarioController', () => {
    ...
    it('should return paginated usuarios', async () => {
        const response = await request(app)
            .get('/api/v1/usuario/page/1/5')  // page 1, limit 5
    ...
    it('should not include deleted items in results', async () => {
        const response = await request(app)
            .get('/api/v1/usuario/page/1/10')
            .set('Authorization', `Bearer ${token}`);
    ...
    it('should return correct page with specified limit', async () => {
        const response = await request(app)
            .get('/api/v1/usuario/page/2/3')  // page 2, limit 3
            .set('Authorization', `Bearer ${token}`);
