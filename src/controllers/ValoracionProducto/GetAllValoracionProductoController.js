...
/**
 *  Controlador encargado de retornar todas las valoraciones de un producto  de la base de datos
 * @class
 * @param {GetAllValoracionProductoService} service - Servicio para obtener todos los registros de la base de datos
 * @returns {GetAllValoracionProductoController} - Instancia del controlador 
...
class GetAllValoracionProductoController{
    ...
    /**
     * Retorn todas las valoraciones de un producto de la base de datos.
     * @param {Object} req - Objeto de solicitud.
     * @param {Object} res - Objeto de respuesta.
     * @returns {Promise<void>} - Promesa que se resuelve cuando se completa la operación.
     * @description Esta función es el endpoint que maneja la obtención de todas las valoraciones de un producto  de la base de datos.
