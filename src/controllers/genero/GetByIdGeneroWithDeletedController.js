...
/**
 * Controlador para obtener un registro de género por su ID incluyendo los registros marcados como eliminados
 * @class
 * @param {GetByIdGeneroService} service - Servicio para obtener un registro de género por su ID
 * @returns {GetByIdGeneroWithDeletedController} - Instancia del controlador
